...
class SystemService:
    ...
    def list_assets(self, page: int = 1, per_page: int = 20,
                    ...
                    useflg: str | None = None, location: str | None = None) -> dict[str, Any]:
        items, total = self._repo.get_cust_pos_rl(
            page=page, per_page=per_page, search=search,
            class_cd=class_cd, asset_type=asset_type, asset_owner=asset_owner, useflg=useflg, location=location)
