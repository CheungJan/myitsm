...
| 6 | 系统参数 | 列表/编辑 | system | 2 | 1页 | app_system.pbl | 完整 |
| 7 | 物料/BOM | 物料清单+BOM结构树 | reports (BOM) | 1 | 2页 | base_cust.pbl | 完整 |
| 8 | 客户主数据 | 列表/详情/分类树 | system | 2 | 2页 | base_cust.pbl | 完整 |
| 9 | EID 管理 | SN码+变更追踪 | — | — | 2页 | base_cust.pbl | 完整 |
| 10 | 资产台账 | 设备-客户关联+asset_type | — | — | 1页 | base_cust.pbl | 完整 |
| 11 | 资产属性扩展 | 扩展属性管理 | — | — | 1页 | base_cust.pbl | 完整 |
...
| 15 | 销售单据 | 列表+审核 | sales | 4 | 1页 | sale.pbl | 完整 |
| 16 | 延期管理 | 列表+创建(含明细) | sales | 4 | 1页 | sale.pbl | 完整 |
| | **仓储管理** | | | | | | |
| 17 | 入库管理 | 8种入库+明细+审核 | warehouse | 4 | 2页 | wh.pbl | 完整 |
