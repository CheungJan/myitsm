...
if not v_newid is null then
  ...
  SELECT (CASE WHEN IS_NEW ='1' THEN 12 WHEN IS_NEW ='0' THEN 3 ELSE 3 END ) INTO v_typ
  FROM TIT25_ACCESSORIES_UPDATE WHERE new_accessories_id = v_newid and maintenance_id = v_mid/*AND auditflg = '1'*/;
