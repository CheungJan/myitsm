    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'itsm/area-management', name: 'AreaManagement', component: () => import('@/views/itsm/AreaManagement.vue'), meta: { title: '区域人员管理' } },
                { path: 'itsm/dispatch-rules', name: 'DispatchRuleList', component: () => import('@/views/itsm/DispatchRuleList.vue'), meta: { title: '派单规则' } },
