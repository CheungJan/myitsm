...
<script setup lang="ts">import {ref,reactive,onMounted} from 'vue';import AppPagination from '@/components/common/AppPagination.vue';import {useListPage} from '@/composables/useListPage';import {fetchStockOut,fetchStockOutDetail,fetchWarehouses,type StockOutRecord} from '@/api/warehouse'
